class Carrito{
    ...
    calcularTotal(){
        ...
        document.getElementById('subtotal').innerHTML = "CS/. " + subtotal;
        document.getElementById('igv').innerHTML = "CS/. " + igv;
        document.getElementById('total').value = "CS/. " + total.toFixed(2);
    }
